...
import { Award, Shield, Users, Heart, ArrowLeft } from 'lucide-react';
        ...
        <div className="max-w-site mx-auto px-4 sm:px-6">
          ...
          >
            <div className="text-center mb-8 md:mb-12">
              <h2 className="font-lora font-semibold text-2xl md:text-3xl lg:text-4xl text-white mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {team.map((member, index) => (
                ...
                >
                  ...
                  <h3 className="font-lora font-medium text-lg md:text-xl text-white mb-2">
                    {member.name}
                  </h3>
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="font-lora font-semibold text-2xl md:text-3xl lg:text-4xl text-champagne-gold mb-2">
                    <span>
                      <CountUpNumber 
                        end={stat.number} 
                        duration={2000} 
